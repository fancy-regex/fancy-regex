...
// x3 tests have an additional argument which is the group number to check.
  ...
  // Compile failed: InvalidEscape(1, "\\O")
  x2("$\\O", "bb\n", 2, 3);

  // Compile failed: InvalidEscape(0, "\\Z")
  x2("\\Z", "", 0, 0);

  // Compile failed: InvalidEscape(0, "\\c")
  x2("\\ca", "\001", 0, 1);
  ...
  // Compile failed: InvalidEscape(2, "\\c")
  x2("q[\\c\\\\]", "q\034", 0, 2);
  ...
  // Compile failed: InvalidEscape(2, "\\Z")
  x2("\\A\\Z", "", 0, 0);

  // Compile failed: InvalidEscape(3, "\\Z")
  x2("xyz\\Z", "xyz", 0, 3);

  // Compile failed: InvalidEscape(1, "\\Z")
  x2("a\\Z", "a", 0, 1);
  ...
  // Compile failed: InvalidEscape(4, "\\Z")
  x2(".(a*\\Z)\\1", "ba", 1, 2);

  // Compile failed: InvalidEscape(3, "\\g")
  x2("(a)\\g<1>", "aa", 0, 2);

  // Compile failed: InvalidEscape(13, "\\g")
  x2("(?<name_2>ab)\\g<name_2>", "abab", 0, 4);

  // Compile failed: InvalidEscape(4, "\\g")
  x2("(?<=\\g<ab>)|-\\zEND (?<ab>XyZ)", "XyZ", 3, 3);

  // Compile failed: InvalidEscape(7, "\\g")
  x2("(?<n>|a\\g<n>)+", "", 0, 0);

  // Compile failed: InvalidEscape(8, "\\g")
  x2("(?<n>|\\(\\g<n>\\))+$", "()(())", 0, 6);

  // Compile failed: InvalidEscape(0, "\\g")
  x3("\\g<n>(?<n>.){0}", "X", 0, 1, 1);

  // Compile failed: InvalidEscape(0, "\\g")
  x2("\\g<n>(abc|df(?<n>.YZ){2,8}){0}", "XYZ", 0, 3);

  // Compile failed: InvalidEscape(9, "\\g")
  x2("\\A(?<n>(a\\g<n>)|)\\z", "aaaa", 0, 4);

  // Compile failed: InvalidEscape(6, "\\g")
  x2("(?<n>|\\g<m>\\g<n>)\\z|\\zEND (?<m>a|(b)\\g<m>)", "bbbbabba", 0, 8);

  // Compile failed: InvalidEscape(15, "\\g")
  ...
  // Compile failed: InvalidEscape(11, "\\g")
  ...
  // Compile failed: InvalidEscape(5, "\\g")
  ...
  // Compile failed: InvalidEscape(21, "\\g")
  ...
  // Compile failed: InvalidEscape(16, "\\Z")
  ...
  // Compile failed: InvalidEscape(12, "\\g")
  x3("(\\(((?:[^(]|\\g<1>)*)\\))", "(abc)(abc)", 1, 4, 2);

  // Compile failed: InvalidEscape(0, "\\o")
  x2("\\o{101}", "A", 0, 1);

  // Compile failed: InvalidEscape(6, "\\g")
  x2("\\A(a|b\\g<1>c)\\k<1+3>\\z", "bbacca", 0, 6);

  // Compile failed: InvalidEscape(10, "\\g")
  ...
  // Compile failed: InvalidEscape(1, "\\g")
  x2("A\\g'0'|B()", "AAAAB", 0, 5);

  // Compile failed: InvalidEscape(2, "\\g")
  x3("(A\\g'0')|B", "AAAAB", 0, 5, 1);

  // Compile failed: UnknownFlag(6, "(?(")
  x2("(a*)(?(1))aa", "aaaaa", 0, 5);

  // Compile failed: UnknownFlag(6, "(?(")
  x2("(a*)(?(-1))aa", "aaaaa", 0, 5);

  // Compile failed: UnknownFlag(14, "(?(")
  x2("(?<name>aaa)(?('name'))aa", "aaaaa", 0, 5);

  // Compile failed: UnknownFlag(5, "(?(")
  x2("(a)(?(1)aa|bb)a", "aaaaa", 0, 4);

  // Compile failed: UnknownFlag(11, "(?(")
  ...
  // Compile failed: InvalidEscape(0, "\\R")
  x2("\\R", "\r\n", 0, 2);
  ...
  // Compile failed: InvalidEscape(0, "\\N")
  x2("\\N", "a", 0, 1);
  ...
  // Compile failed: InvalidEscape(4, "\\O")
  x2("(?m:\\O)", "\n", 0, 1);

  // Compile failed: InvalidEscape(5, "\\O")
  x2("(?-m:\\O)", "\n", 0, 1);
  ...
  // Compile failed: InvalidEscape(14, "\\g")
  x2("((?<x>abc){0}a\\g<x>d)+", "aabcd", 0, 5);

  // Compile failed: UnknownFlag(3, "(?(")
  x2("((?(abc)true|false))+", "false", 0, 5);

  // Compile failed: UnknownFlag(12, "(?(")
  ...
  // Compile failed: InvalidEscape(9, "\\Z")
  x2("むめも\\Z", "むめも", 0, 9);
  ...
  // Compile failed: InvalidEscape(7, "\\Z")
  x2("鬼|車\\Z", "車鬼", 3, 6);
  ...
  // Compile failed: InvalidEscape(5, "\\Z")
  x2("(あ*\\Z)\\1", "あ", 3, 3);

  // Compile failed: InvalidEscape(6, "\\Z")
  x2(".(あ*\\Z)\\1", "いあ", 3, 6);

  // Compile failed: InvalidEscape(16, "\\g")
  x2("(?<愚か>変|\\(\\g<愚か>\\))", "((((((変))))))", 0, 15);
  ...
  // Compile failed: UnknownFlag(2, "(?-W")
  x2("(?-W:\\p{Word})", "こ", 0, 3);
  ...
  // Compile failed: UnknownFlag(2, "(?-D")
  x2("(?-D:\\p{Digit})", "３", 0, 3);

  // Compile failed: UnknownFlag(2, "(?-S")
  x2("(?-S:\\p{Space})", "\xc2\x85", 0, 2);

  // Compile failed: UnknownFlag(2, "(?-P")
  x2("(?-P:\\p{Word})", "こ", 0, 3);
  ...
  // Compile failed: InvalidEscape(1, "\\Y")
  x2(".\\Y\\O", "\x0d\x0a", 0, 2);

  // Compile failed: InvalidEscape(1, "\\Y")
  x2(".\\Y.", "\x67\xCC\x88", 0, 3);

  // Compile failed: InvalidEscape(0, "\\y")
  x2("\\y.\\Y.\\y", "\x67\xCC\x88", 0, 3);

  // Compile failed: InvalidEscape(0, "\\y")
  x2("\\y.\\y", "\xEA\xB0\x81", 0, 3);

  // Compile failed: InvalidEscape(2, "\\Y")
  ...
  // Compile failed: InvalidEscape(3, "\\Y")
  x2("...\\Y.", "\xE3\x80\xB0\xCC\x82\xE2\x80\x8D\xE2\xAD\x95", 0, 11);

  // Compile failed: InvalidEscape(1, "\\X")
  x2("^\\X$", "\x0d\x0a", 0, 2);
  ...
  // Compile failed: UnknownFlag(2, "(?y")
